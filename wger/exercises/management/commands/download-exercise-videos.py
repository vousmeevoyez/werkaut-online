...
class Command(BaseCommand):
    """
    Download exercise videos from werkaut.online and updates the local database

    Both the exercises and the videos are identified by their UUID, which can't
    be modified via the GUI.
    """

    help = 'Download exercise videos from werkaut.online and update the local database'
