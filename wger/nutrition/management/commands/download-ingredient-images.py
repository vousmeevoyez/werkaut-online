...
class Command(BaseCommand):
    """
    Download ingredient images from werkaut.online and updates the local database
    ...
    help = (
        'Download ingredient images from werkaut.online and update the local database\n'
        '\n'
