...
class TestMakeUri(unittest.TestCase):
    ...
    def test_make_uri(self):
        ...
        self.assertEqual(
            make_uri("test"),
            "https://werkaut.online/api/v2/test/",
        )
        ...
        self.assertEqual(
            ...
            "https://werkaut.online/api/v2/test/123/",
        )

        # Test with object_method
        self.assertEqual(
            make_uri("test", object_method="create"),
            "https://werkaut.online/api/v2/test/create/",
        )
        ...
        self.assertEqual(
            ...
            "https://werkaut.online/api/v2/endpoint/?key1=value1&key2=value2",
        )

        # Test with all parameters
        self.assertEqual(
            make_uri("test", id=123, object_method="create", query={"key1": "value1"}),
            "https://werkaut.online/api/v2/test/123/create/?key1=value1",
        )
